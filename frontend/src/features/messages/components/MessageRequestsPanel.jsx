...
const MessageRequestsPanel = () => {
  ...
  if (!requests.length) {
    return (
      <div className="p-4">
        <p className="text-sm text-slate-500">No message requests.</p>
      </div>
    );
  }
  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="border-b border-slate-200 p-4">
        <h2 className="text-xl font-bold text-slate-950">Message Requests</h2>
            ...
            <div key={conversation._id} className="p-4">
              ...
              <div className="mt-3 flex gap-2">
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-slate-950 px-3 py-2 text-sm font-semibold text-white"
                >
                  <Check size={16} />
                  Accept
                </button>
                ...
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-300 px-3 py-2 text-sm font-semibold text-slate-700"
                >
                  <X size={16} />
                  Delete
                </button>
